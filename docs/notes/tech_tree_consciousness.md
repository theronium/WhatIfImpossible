...
type: note
date: 2026-04-09
related: [wiim_042, wiim_046, wiim_048, wiim_051, wiim_073, wiim_107, wiim_120]
---
...
flowchart LR
    ...
    CON29 --> CON33[哲学的ゾンビコスト問題 g445\n発生コスト＝意識体と同一・検証も閉じる]
    CON33 --> CON34[自然発生の思考実験 wiim_107\nボルツマン脳はゾンビか意識体か判別不能]
    CON34 --> CON22

    CON13 --> CON35[群知性への断片統合 wiim_120\nコズミックマイス個体群への胞子送信]
    CON35 --> CON36[クローン禁止定理 g487\n断片化は必然・完全複製は不可能]
    CON35 --> CON37[統合閾値問題\nシャノン通信路容量 vs ネットワークの地質学的時間スケール]
    CON36 & CON37 --> CON33
```
...
| 哲学的ゾンビコスト問題 | 発生コストが意識体と同一なうえ、発生後も検証する情報が存在しない——二重に閉じた問い |
| 自然発生の思考実験（wiim_107） | 物理主義の正否にかかわらず「これはゾンビか」に答える道がない |
| 群知性への断片統合（wiim_120） | クローン禁止定理により断片化が必然・統合閾値を超えたか生前には判定不能 |
