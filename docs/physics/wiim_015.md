...
ここで重要な補足がある。「時間が逆向きに流れる宇宙ではエントロピーが自然に減少する」という表現は外部からの視点であり、その宇宙の住人の視点では成立しない。時間反転対称なミクロ法則のもとでは、エントロピーは「記憶のある方向」＝その宇宙での「過去」から「未来」に向かって増大する。住人たちも自分たちの時間の向きに沿ってエントロピーが増えると体験するだろう——ただその向きが私たちから見て逆なだけだ。「エントロピー減少宇宙」は私たちの視点での呼称であり、内部の物理法則の違いではなく**初期条件の差異**によって成立する。
...
- [wiim_088](wiim_088.md) — 負のエネルギーを制御できたなら何が変わるか
