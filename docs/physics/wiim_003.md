...
理論上、重力と逆向きの効果は時間を遅らせるのではなく**速める**方向に働くと考えられる。タキオン（虚数質量を持つ仮説上の粒子）の「逆」として発想されたこの粒子は、厳密には虚数質量の反転ではなく、**負の実質量**を持つ粒子として定式化される。

ここで用語を整理しておく。**エキゾチック物質**とはワームホールやアルクビエレ・ドライブの理論で用いられる概念で、「**負のエネルギー密度**」を持つ物質の総称だ。一方、本記事で「ネゴトン」と呼ぶ粒子は「**負の実質量**」という粒子そのものの属性を指しており、定義の出発点が異なる。ネゴトンはエキゾチック物質の一種と見なすこともできるが、エキゾチック物質が必ずしも負の質量を持つわけではない点に注意されたい（カシミール効果が生む負のエネルギー密度は、負の質量とは別の現象である）。
...
より正確に言えば、「時間が速まる」とは固有時の進み方が外部より速くなることを指す——一般相対論的には「負の重力ポテンシャル井戸の外側では固有時が速く進む」の反転として、負質量周辺では「正の重力ポテンシャルの頂上」が形成され、そこでは固有時が周囲より速く進む。「時間加速」という表現は直感的な便宜的呼称であり、時空の曲率が根本的に変わることを意味するわけではない。
...
- [wiim_001](../cosmology/wiim_001.md) — 光速を超えた場合の因果律への影響（タキオンとの比較）
- [wiim_002](../cosmology/wiim_002.md) — 相対的に時間を進められる空間（本記事の応用シナリオ）
...
- [wiim_009](../cosmology/wiim_009.md) — 重力波をキャンセルする——時空のノイズキャンセリングと完全ステルスの攻防
...
- [wiim_080](wiim_080.md) — ネゴトンホワイトホールワープ——安定維持した排除地平線を推進力に転用できるか
