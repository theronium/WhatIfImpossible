...
理論上、重力と逆向きの効果は時間を遅らせるのではなく**速める**方向に働くと考えられる。タキオン（虚数質量の仮想粒子）の「逆」として発想されたこの粒子は、厳密には虚数質量の反転ではなく、**負の実質量**あるいは**負のエネルギー密度を生成できる粒子**として定式化される。
