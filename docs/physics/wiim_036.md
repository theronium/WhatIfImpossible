...
アンキロンが固定するのは空間的距離だけではない。計量テンソルは空間成分と時間成分を一体として記述するため、アンキロンの粘性的抵抗は局所的な固有時の変動も減衰させる。これは時間を「止める」ことではなく、計量の揺らぎを抑えて安定した変化率に落ち着かせることを意味する——固有時は流れ続けるが、その速さが外乱に揺さぶられにくくなる。アンキロンは時計ではなく**安定した時空点という目印**だ。暦として機能するのは、アンキロンが作り出したこの安定点に惑星が物理的に帰還するという事実による。
