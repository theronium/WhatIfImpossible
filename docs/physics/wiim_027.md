...
ストレンジスターの重力が「通常の恒星の重力と質的に違う」という根拠が必要だ。ストレンジ物質は状態方程式が通常の核物質と異なり、時空計量に固有の特徴を生み出す可能性があるが、これは現在の観測・理論では確認されていない。ストレンジスターが普通の中性子星と重力的に区別できなければ、チューニング効果は存在しないことになる。
