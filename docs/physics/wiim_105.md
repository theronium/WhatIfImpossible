...
8. **主ノード/従ノード設計**  
   12基を均等に扱う代わりに、3〜4基を能動的な「主ノード」、残り8〜9基を受動的な「従ノード」として役割を分ける。主ノードはスラスターと精密姿勢制御機構を搭載し、デブリ衝突・熱サイクル・月の潮汐力などによるケーブルテンションの摂動を常時補正する。従ノードは推進機構を持たず、カテナリーのテンション変化を通じて主ノードの補正に受動的に追従する。間欠展開時に推進剤を消費するのは主ノードだけであり、従ノードは全期間を通じて推進剤ゼロで運用できる。この役割分担は土星の輪を安定させる羊飼い衛星（シェパード衛星）の原理と同一であり、少数の能動的制御点が多数の受動的要素を束ねる階層構造だ。
...
12基が等間隔に並ぶことへの軌道力学的な懸念——クレンペラーロゼット型の等質量配置が相互に重力干渉するのではないか——は、実際には問題にならない。地球と人工衛星の質量比は 10²¹ 以上であり、衛星間の相互引力は地球重力の 10¹⁸ 分の1以下だ。GEOネックレスは重力的にはすでに完璧な主従系として成立しており、軌道の不安定性は設計の課題ではない。問題はケーブル結合に由来する構造的不安定性だ——1基が摂動を受けると張力変化がケーブルを伝わって全体に波及する。主ノード/従ノードの役割分担はこの構造的結合の問題を、軌道力学が階層的質量比で干渉を消すのと同じ原理で解く。制御の階層を設け、少数の能動的な主が多数の受動的な従を支配する構造にすることで、摂動の伝播を吸収させる。
