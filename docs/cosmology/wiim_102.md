...
この思考実験は「ワームホールを音響チャネルとして使う」という問いを立てる。通常の星間媒質（ISM）を音速で伝わる場合、最も近い恒星系まで13万年以上かかる音響信号が、ワームホール経路では瞬時に近い時間で届きうる。ただしその実現には可通ワームホールの維持と、スクランブルされた量子情報の復元という二つの独立した障壁がある。音響情報を量子状態として符号化しブラックホールへ投入する工程自体は、特別な結合機構を要しない平凡な工学である。
...
### 技術的限界：符号化の平易さと復号の途方もなさ

音響情報を運ぶ媒体はフォノンである必要はない。マイクロホン等で音波形を電気信号に変換し、光子や他の量子ビットとして符号化してBH-Aに投入すれば、情報としての音は運べる——これは日常の音声通信（マイク→電波→スピーカー）と原理的に同じ構造であり、フォノンという運搬体そのものを最後まで維持する必然性はない。したがって「SASERとER橋の結合機構が存在しない」という形で障壁を立てるのは成立しない。物質・エネルギーをブラックホールへ投げ込むこと自体は特別な結合機構を要さない、ごくありふれた天体現象である。

問題は入口ではなく出口に集中する。ブラックホールに落ちた情報は量子スクランブリングによって全ホーキング輻射に分散される。ヘイデン＝プレスキル回路の原理では早期ホーキング輻射という「参照系」があれば情報を復元できるが、太陽質量のブラックホールの場合この参照系を約10⁶⁷年にわたって量子コヒーレントに保持し続けることが条件となる——宇宙年齢を10⁵⁷倍した時間である。符号化そのものは平凡な工学であっても、復元に要する時間スケールがこの思考実験の実現不可能性の中心を担っている。
...
**操作の連鎖**:
1. 音情報を量子状態として符号化する（SASERによるコヒーレントフォノン化はその一例にすぎない）
...
- [wiim_135](../physics/wiim_135.md) — フォノンはヘリウムになれるか——ボース統計が阻む複合粒子化
