...
id: wiim_050
category: quantum
tags: [量子デコヒーレンス, マクロ量子状態, 量子古典境界, 二重スリット実験, シュレーディンガーの猫, アンキロン, コーラ粒子, 波と粒子の二重性]
date: 2026-03-28
---
...
人間の目で見える最小サイズはおよそ0.1ミリ（100マイクロメートル）だ。これは炭素原子を一列に並べれば約100万個分にあたる。そのような「巨大粒子」が量子力学的に1個の粒子として振る舞う——位置が確定せず、二か所に同時に存在し、干渉縞を作る——ことは可能なのか。

答えは「不可能」だ。ただし、その理由は素朴に「大きすぎる」からではない。**量子デコヒーレンス**という物理機構が、サイズの増大に伴って指数関数的に量子性を奪っていく。
