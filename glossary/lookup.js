...
// 使い方:
//   node glossary/lookup.js g056
//   node glossary/lookup.js ダークマター
//   node glossary/lookup.js dark      ← 部分一致（name/en/aliases）
'use strict';
...
if (!query) {
  console.error('使い方: node glossary/lookup.js <ID|用語名|部分一致>');
  process.exit(1);
}
